...
public class ScatterChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBarX.setProgress(24);
        seekBarY.setProgress(120);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        for (int i = 0; i < seekBarX.getProgress(); i++) {
            float val = (float) (Math.random() * 30) + 80;
        ...
        ScatterDataSet set1 = new ScatterDataSet(values1, "심장박동");
        set1.setScatterShape(ScatterChart.ScatterShape.CIRCLE);
        set1.setColor(ColorTemplate.COLORFUL_COLORS[0]);

        ScatterDataSet set2 = new ScatterDataSet(values2, "동작감지");
        set2.setScatterShape(ScatterChart.ScatterShape.CIRCLE);
        set2.setColor(ColorTemplate.COLORFUL_COLORS[1]);

        ScatterDataSet set3 = new ScatterDataSet(values3, "인체감지");
